...
const Hero = () => (
    <div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24" id='falemais'>
        <div class="flex flex-col w-full lg:w-1/2 justify-center items-start pt-12 pb-24 px-6">
            <p class="uppercase tracking-loose font-semibold">Novidade</p>
            <h1 class="font-bold text-3xl">FALE MUITO MAIS!</h1>
