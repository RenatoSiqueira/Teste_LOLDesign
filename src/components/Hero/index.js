...
const Card = ({ icon, title, text }) => (
    <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex flex-col text-center items-center">
        ...
        <div class="flex-grow">
            ...
            <a class="mt-3 text-indigo-500 inline-flex items-center">Veja Mais
    ...
    <section class="text-gray-700 body-font">
        <div class="container px-5 py-20 mx-auto">
            <div class="text-center mb-20">
                <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 mb-4">Plano FaleMais</h1>
            ...
            <button class="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Descubra qual é seu futuro Plano</button>
        </div>
    </section>
)
